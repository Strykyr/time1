...
import os
import torch
from exp.exp_test import Exp_Main
import random
import numpy as np
...
# data loader
# 自己的dataset
parser.add_argument('--folder_path', type=str, required=True, default='D:/fire/data/2500/', help='dataset type')
...
# optimization, windows使用0多进程，只有主进程工作
